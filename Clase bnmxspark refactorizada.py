...
if (-not (Test-Path $outputDir)) {
    ...
    # 2) Agrupar archivos *_DDMMYYYY.txt por fecha (últimos 8 dígitos antes de .txt)
    Get-ChildItem -Path $scriptDir -Filter '*_????????.txt' |
      Group-Object -Property {
                        ...
                        $fecha = $_.Name
                              $files = $_.Group
                                    $out   = Join-Path $outputDir "concatenado_$fecha.txt"
                                          ...
                                          # Asegurarnos de empezar de cero
                                                if (Test-Path $out) { Remove-Item $out }

                                                      if ($files.Count -eq 1) {
                                                                # Caso 1 solo archivo: lo leemos y lo guardamos en UTF-8
                                                                          Get-Content $files[0].FullName |
                                                                                      Set-Content -Path $out -Encoding UTF8
                                                                                                Write-Host "► [$fecha] Un archivo — copiado completo en UTF-8: $($files[0].Name)"
                                                                                                      }
                                                                                                            else {
                                                                                                                      # Caso múltiples archivos
                                                                                                                                $primero = $true
                                                                                                                                          foreach ($f in $files) {
                                                                                                                                                        if ($primero) {
                                                                                                                                                                          # Primer archivo: todo el contenido
                                                                                                                                                                                            Get-Content $f.FullName |
                                                                                                                                                                                                                Set-Content -Path $out -Encoding UTF8
                                                                                                                                                                                                                                  $primero = $false
                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                              else {
                                                                                                                                                                                                                                                                                # Resto: saltar línea 1 y añadir en UTF-8
                                                                                                                                                                                                                                                                                                  Get-Content $f.FullName |
                                                                                                                                                                                                                                                                                                                      Select-Object -Skip 1 |
                                                                                                                                                                                                                                                                                                                                          Add-Content -Path $out -Encoding UTF8
                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                                  }
                                                                                                                                                                                                                                                                                                                                                                            Write-Host "► [$fecha] Concatenados en UTF-8 → $out"
                                                                                                                                                                                                                                                                                                                                                                                  }
                                                                                                                                                                                                                                                                                                                                                                                    }
